...
function SignUp() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch(`${import.meta.env.VITE_URI_GRAPH}/user/signup`, {
      method: "POST",
      headers: {
            ...
            <form action="#" method="POST" onSubmit={handleSubmit} className="mt-5">
              <div className="space-y-5">
                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <a
                      href="#"
                      title=""
                      className="text-[#DE38A6] hover:text-blue-700 hover:underline"
                    >
                      Terms of Service
                    </a>{" "}
                    and{" "}
                ...
                <div>
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-[#DE38A6] border border-transparent rounded-md focus:outline-none hover:bg-[#DE38A6] "
                  >
                    Create account
                  </button>
                </div>
                ...
                <div className="text-center">
                  <p className="text-base text-gray-600">
                    ...
                    <a
                      href="#"
                      title=""
                      className="font-medium text-[#DE38A6] transition-all duration-200 hover:text-[#DE38A6] hover:underline"
                    >
                      Login here
                    </a>
                  </p>
